...
public class ColumnConfig
{
  ...
  /// <summary>
  ///     If the <see cref="Type" /> is <see cref="DataType.StringFormat" /> you can specify any a format to use when
  ///     generating
  ///     that data
  ...
  /// <summary>
  ///     When true, if the data loaded from the source is an empty string (String.IsNullOrWhitespace), then no new data will
  ///     be generated.
  ///     When false, if the data loaded from the source is an empty string (String.IsNullOrWhitespace) it will be replaced
  ///     by new data
  /// </summary>
  /// <value>
